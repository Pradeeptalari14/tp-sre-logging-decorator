# 🩺 SRE logging Decorator

> JSON decorator redacting PII data and outputting logs configured for AWS CloudWatch and Grafana.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/sre-logging-decorator/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-sre-logging-decorator.git
cd tp-sre-logging-decorator
```
...
```bash
kubectl port-forward deployment/tp-sre-logging-decorator 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── json_logger.py     # Main configuration file
```
...
---
*Generated by [SRE logging Decorator Studio](https://pradeeptalari14.github.io/portfolio/tools/sre-logging-decorator/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
